...
export const PRICING_TIERS = [
  {
    name: "LOUP WiFi",
    price: "$149",
    period: "$199 at launch",
    highlight: true,
    features: [
      "LOUP↔LOUP always free",
      "External contacts $10/mo",
      "Home, school, saved WiFi, parent hotspot",
      "Same closed contact list",
      "No carrier plan",
    ],
    cta: "Pre-order WiFi",
    href: "/shop/loup",
  },
  {
    name: "LOUP WiFi + LTE",
    price: "$199",
    period: "$249 at launch",
    highlight: false,
    features: [
      "Everything in LOUP WiFi",
      "LTE included — no extra carrier contract",
      "Reachable when WiFi isn't around",
      "Still no browser, no open internet",
      "Same parent controls",
    ],
    cta: "Pre-order LTE",
    href: "/shop/loup",
  },
