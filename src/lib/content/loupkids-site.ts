...
export const LOUPKIDS_IMAGES = {
  ...
  raiseHeroContacts: R("raise-hero-contacts.png"),
...
export const LOUPKIDS_STATS = [
  {
    ...
    text: "Unstructured free play has dropped over 25% as structured screen time and algorithmic devices replaced real-world play.",
  },
  {
    title: "The Play Gap.",
  ...
  },
  {
    ...
    text: "Nearly 1 in 2 teens report being online almost constantly, and 95% have smartphone access.",
    citeHref: "https://www.pewresearch.org/internet/2024/12/12/teens-social-media-and-technology-2024/",
    citeLabel: "Pew Research, 2024",
  },
] as const;
...
export const LOUPKIDS_PHONE = {
  ...
  subtitle:
    "They stay connected. You stay in control. Zero dopamine feeds. Zero open internet browsing. No compromise.",
};
...
export const LOUPKIDS_ABOUT = {
  ...
  paragraphs: [
    "Our daughter came into our office and found an old phone sitting on the floor—one of those heavy, plastic relics from before everything had a screen.",
    ...
    "In mid 2025 our daughter got a pair of walkie-talkies. She handed one to a friend down the street, and the game became real. They were talking every day, sharing everything:",
    "\"My dad stepped in dog 💩 today.\" \"I saw Goonies last night.\" \"Want to come over to play?\"",
    "It was simple, playful, real.",
    "At the same time, we kept seeing headlines about kids and screens—anxiety, distraction, lost sleep.",
    "Parents everywhere were trying to balance connection and protection. We felt it too. Our daughter's friends were already getting smartphones, and it was hard not to feel the pressure.",
...
export const LOUPKIDS_FAQ: { q: string; a: LoupkidsFaqAnswer }[] = [
  {
    q: "What is Loup?",
    a: "Loup is a voice-first family communications device for kids — e-ink display, no feeds, no social media, no open browsing. Built for simple, safe connection with parent-approved contacts over Wi-Fi.",
  },
  {
  ...
  },
  {
    ...
    a: {
      ...
      paragraphs2: [
        "It's designed to be Parent-Controlled, Not Surveillance-Oriented—focusing on guidance without tracking, spying, or overreach. Kids can only communicate with approved contacts who are part of the closed Loup system. This ensures no strangers or random calls.",
      ],
    },
  },
  {
    ...
    a: {
      paragraphs: [
        "A landline keeps kids connected to a wall. LOUP keeps them connected to you.",
        "There's a reason kids stopped using landlines — they're tethered, fixed, and useless the moment they walk out the door. Creativity, independence, and real childhood happen outside. In the backyard. At a friend's house. At the park. A device that only works in the kitchen isn't a solution — it's a compromise.",
        "LOUP goes where kids go. It fits in a pocket, clips to a backpack, and works on any Wi-Fi network — home, school, a grandparent's house. The freedom to roam is the whole point. We didn't build a smarter landline. We built the phone that comes before the smartphone.",
      ],
    },
  },
  {
  ...
  },
  {
    ...
    a: {
      paragraphs: [
        ...
        "Some devices in this space ask you to physically print out a sheet of numbers and tape it to the keypad so kids know who they're calling. We wish we were joking. That's not a product — that's a workaround.",
        "Kids need a contact list they can actually navigate. LOUP's e-ink display is the size of a name tag and uses less power than a wall clock. It shows exactly who they're calling — a name, not a number — scrolled through with a single dial. No apps. No browser. No rabbit holes. Just a rolling list of the people they're allowed to reach.",
...
export const LOUPKIDS_COMPARISON = {
  columns: ["LOUP", "Smartphone", "Kids smartwatch", "Landline"],
  rows: [
    {
      label: "Screen type",
      values: ["E-paper (zero feeds)", "LCD / OLED", "LCD + apps", "None / keypad"],
    },
    {
      label: "Dopamine feeds",
      values: ["None — physically impossible", "The whole product", "Some models", "None"],
    },
    {
      label: "Open internet",
      values: ["Zero browsing", "Full access", "Restricted / varies", "None"],
    },
    {
    ...
    },
    {
      ...
      values: ["Yes, enforced in hardware", "No", "Usually", "No — anyone can dial"],
    },
    {
      label: "Data privacy",
      values: [
...
export const LOUPKIDS_JOURNAL_EXCERPTS: Record<string, string> = {
  ...
  "wait-until-8th-and-the-strategy-of-collective-bargaining":
    "The \"Wait Until 8th\" pledge is a masterclass in collective bargaining. But simply subtracting a smartphone without substituting it with a deployable, real-world tool sets parents up to fail. Here is how to actually execute the boundary without leaving kids disconnected.",
  "the-tactical-surrender-of-the-middle-school-smartphone":
  ...
  "the-borrowed-childhood":
    "Childhood isn't disappearing all at once. It's being borrowed—minute by minute, notification by notification. We're losing the war for kids' attention to algorithms engineered like slot machines. Here is why we're fighting for the \"gap years\" and why boredom might be the best gift you ever give kids.",
  "white-tactile-neurodivergence-and-hard-of-sight":
