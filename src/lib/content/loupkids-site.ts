...
export const LOUPKIDS_STORE = {
  headline: "Not a Land Line",
  subheadline: "Pre-Order Line.",
  sectionLabel: "Store",
...
export const LOUPKIDS_STORE_PRODUCTS = [
  {
    title: "Reserve your Spot (limited quantity)",
    price: 1,
    compareAt: null as number | null,
    note: "",
    image: LOUPKIDS_IMAGES.reserve,
    href: "/shop/loup",
    sizes: [] as string[],
  },
  {
    title: "Loup OG - 1 in 31 Edition",
    price: 149,
    compareAt: 199,
    note: "Reserve yours for early 2027 shipping",
    image: LOUPKIDS_IMAGES.loup31,
    href: "/shop/loup",
    sizes: [],
  },
  {
    ...
    compareAt: 199,
    note: "Reserve yours for early 2027 shipping",
    image: LOUPKIDS_IMAGES.loupBlack,
    href: "/shop/loup",
    sizes: [],
  },
  {
    ...
    compareAt: 199,
    note: "Reserve yours for early 2027 shipping",
    image: LOUPKIDS_IMAGES.loupRed,
    href: "/shop/loup",
    sizes: [],
  },
  {
    title: "Loup OG - Aluminium",
    price: 149,
    compareAt: 199,
    note: "Reserve yours for early 2027 shipping",
  ...
  {
    title: "Strikeout the Algo Youth",
    price: 40,
    compareAt: null,
    note: "",
    image: LOUPKIDS_IMAGES.sweater,
    href: "/shop",
    sizes: ["XS", "S", "M", "L", "XL"],
  },
  {
    title: "Strikeout the Algo Beanie",
    price: 17,
    compareAt: null,
    note: "",
    image: LOUPKIDS_IMAGES.whiteBag,
    href: "/shop",
    sizes: [],
  },
  {
    title: "Youth T-Shirt | Strikeout the Algo",
    price: 14,
    compareAt: null,
    note: "",
    image: LOUPKIDS_IMAGES.kidSmile,
    href: "/shop",
    sizes: ["XS", "S", "M", "L", "XL"],
  },
  {
    title: "Strikeout the Algo Kids",
    price: 30,
    compareAt: null,
    note: "",
  ...
  {
    title: "Strikeout the Algo Adult",
    price: 49.99,
    compareAt: null,
    note: "",
    image: LOUPKIDS_IMAGES.kidsPhonesTout,
    href: "/shop",
