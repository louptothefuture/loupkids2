...
export const MOCK_LOUP: Product = {
  ...
  title: "Loup",
  description:
    "The phone before their first smartphone. Kids stay reachable. You stay in control. Parent-approved contacts only — no feeds, no apps, no open internet. First 500 for $129 — year 1 unlimited domestic included, then $10/mo.",
  descriptionHtml:
  ...
  variants: [
    {
      ...
      image: {
        ...
        altText: "Loup — LOUP wordmark on e-ink face",
        width: 768,
        height: 1024,
      },
    },
  ...
  images: [
    {
      url: "/images/renders/shop/a_4.jpg",
      altText: "Loup silver — three-quarter with LOUP wordmark",
      width: 768,
      height: 1024,
    },
    {
      url: "/images/renders/shop/a_hi.jpg",
      altText: "Loup silver — front face showing hi",
      width: 768,
      height: 1024,
    },
    {
    ...
    {
      url: "/images/renders/shop/a_power.jpg",
      altText: "Loup silver — power side with status LED",
      width: 1000,
      height: 1000,
    },
    {
      url: "/images/renders/shop/a_bottom.jpg",
  ...
  seo: {
    ...
    description:
      "Loup is the smartphone alternative for kids. Aluminum sides and buttons, ABS front. Voice calls to a parent-approved list. First 500 for $129 (Save 33% vs $199). Year 1 unlimited domestic included, then $10/mo. Ships within 60 days.",
  },
};
