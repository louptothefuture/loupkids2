...
export const MOCK_LOUP: Product = {
  ...
  images: [
    {
      url: "/images/renders/d.jpg",
      altText: "Loup silver — front with wordmark",
      width: 900,
      height: 1024,
    },
    {
      url: "/images/renders/three-quarter.jpg",
      altText: "Loup three-quarter view",
      width: 900,
      height: 1024,
    },
    {
      url: "/images/renders/m.jpg",
      altText: "Loup angled — hi. on e-ink strip",
      width: 900,
      height: 1024,
    },
    {
      url: "/images/renders/back.jpg",
      altText: "Loup back panel and scroll dial",
      width: 900,
      height: 1024,
    },
    {
      url: "/images/lifestyle-new/hand-holding-hi.jpg",
      altText: "Hand holding Loup showing hi.",
      width: 900,
      height: 1024,
    },
    {
      url: "/images/lifestyle-new/bag-pocket.jpg",
      altText: "Loup in a bag pocket",
      width: 900,
      height: 1024,
    },
  ],
