...
export const MOCK_LOUP: Product = {
  ...
  images: [
    ...
    {
      url: "/images/renders/shop/studio/03-back.jpg",
      altText: "Loup silver — back plate with corner screws",
      width: 1400,
      height: 1400,
    },
    {
      url: "/images/renders/shop/studio/04-usb.jpg",
      altText: "Loup silver — USB-C bottom edge",
      width: 1400,
      height: 1400,
    },
    {
      url: "/images/renders/shop/studio/05-front.jpg",
      altText: "Loup silver — front face",
      width: 1400,
      height: 1400,
    },
    {
      url: "/images/renders/shop/studio/06-scroll.jpg",
