...
export const MOCK_LOUP: Product = {
  ...
  images: [
    {
      url: "/images/renders/shop/studio/01-three-quarter.jpg",
      altText: "Loup silver — three-quarter, e-ink and scroll dial",
      width: 768,
      height: 1024,
    },
    {
      url: "/images/renders/shop/studio/02-volume.jpg",
      altText: "Loup silver — volume rocker side",
      width: 1000,
      height: 1000,
    },
    {
      url: "/images/renders/shop/studio/03-scroll.jpg",
      altText: "Loup silver — scroll dial side",
      width: 1000,
      height: 1000,
    },
    {
      url: "/images/renders/shop/studio/04-back.jpg",
      altText: "Loup silver — back plate with corner screws",
      width: 768,
      height: 1024,
    },
    {
      url: "/images/renders/shop/studio/05-usb.jpg",
      altText: "Loup silver — USB-C bottom edge",
      width: 1000,
      height: 1000,
    },
    {
      url: "/images/renders/shop/studio/06-three-quarter-left.jpg",
      altText: "Loup silver — three-quarter with LOUP on e-ink",
      width: 768,
      height: 1024,
    },
  ],
