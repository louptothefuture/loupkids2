export const SITE = {
  ...
  description:
    "Loup is the phone before their first smartphone — approved contacts only, no feeds, no algorithms. WiFi $149 or WiFi + LTE $199 pre-order. LOUP↔LOUP always free. External contacts $10/mo.",
