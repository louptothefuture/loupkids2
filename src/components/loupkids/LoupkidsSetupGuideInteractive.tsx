...
/** Same 3-step walkthrough layout as live — GIFs when SVG assets 500 */
const STEP_VISUALS: Visual[] = [
  {
    src: "/images/setup/loup-setup.gif",
    alt: "Parent app setup — create an account, scan the device code, choose Wi-Fi, and finish setup",
    kind: "phone",
    mediaLabel: "In the parent app",
  },
  {
    src: "/images/setup/loup-manage.gif",
    alt: "Parent app — review, add, and confirm an approved contact",
    kind: "phone",
    mediaLabel: "Still in the parent app",
  },
  {
    src: "/images/setup/loup-call-flow.gif",
    alt: "Loup contact selection, outgoing and incoming calls, active call, volume, mute, and call end",
    kind: "phone",
    mediaLabel: "On kids’ Loup",
  },
];
