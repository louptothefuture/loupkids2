...
export function LoupkidsHardwarePillars() {
  return (
    <section className="lk-section-white border-b border-[var(--lk-line)] px-[var(--lk-section-x)] py-16 sm:py-20">
      <div className="mx-auto max-w-[1100px]">
        ...
        <div className="mt-12 grid gap-px overflow-hidden rounded-2xl border border-[var(--lk-line)] bg-[var(--lk-line)] sm:mt-14 sm:grid-cols-2">
          {HOME_PILLARS.map((card, i) => (
            <FadeIn key={card.title} delay={0.03 + i * 0.04} className="bg-white p-7 sm:p-9">
