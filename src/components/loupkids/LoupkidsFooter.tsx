...
export function LoupkidsFooter() {
  return (
    <footer className="lk-section-black border-t border-white/10 px-[var(--lk-section-x)] py-12 text-white sm:py-14">
      <div className="lk-container">
        <p className="mx-auto max-w-xl text-center text-[0.9375rem] leading-relaxed text-white/70">{LOUPKIDS_FOOTER.body}</p>
        ...
        <p className="mt-10 text-center text-xs text-white/35">© {new Date().getFullYear()} Loup</p>
      </div>
    </footer>
  );
}
