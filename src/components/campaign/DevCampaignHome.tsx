...
export async function DevCampaignHome() {
  ...
  return (
    <>
      {/* HERO */}
      <section className="relative overflow-hidden border-b-2 border-ink bg-[var(--lk-surface)]">
        <div className="mx-auto grid max-w-7xl items-center gap-10 px-4 py-16 sm:px-6 lg:grid-cols-[1.1fr_1fr] lg:gap-12 lg:py-20">
          <div className="relative z-10">
            <p className="label-mono mb-4 inline-block border-2 border-ink bg-[var(--lk-surface)] px-3 py-1">
          ...
          <div className="relative mx-auto w-full max-w-md lg:max-w-none">
            <div className="relative aspect-[4/5] overflow-hidden rounded-t-[2rem] border-2 border-b-0 border-ink">
              ...
              />
              <span className="label-mono absolute bottom-4 left-4 border-2 border-ink bg-[var(--lk-surface)] px-2 py-1">
      ...
      {/* STATS */}
      <section className="border-b-2 border-ink bg-[var(--lk-cream)] py-16 lg:py-20">
          ...
          <div className="mt-10 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
            {STATS.map((item, i) => (
              <Reveal key={item.stat} delay={i * 0.06}>
                <div className="h-full rounded-2xl border-2 border-ink bg-[var(--lk-surface)] p-6">
      ...
      <section className="border-b-2 border-ink bg-[var(--lk-surface)] py-20 lg:py-24">
        <div className="mx-auto max-w-7xl px-4 sm:px-6">
          <Reveal>
          ...
          <div className="mt-10 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {LOUPKIDS_NOTHING.items.map((item) => (
              <Reveal key={item.title}>
                <div className="h-full rounded-2xl border-2 border-ink bg-[var(--lk-cream)] p-6">
      ...
      <section className="mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:py-24">
        ...
        <div className="mt-10 mx-auto max-w-sm">
          <Reveal>
            <Link
              href="/shop/loup"
              className="group block overflow-hidden rounded-2xl border-2 border-ink bg-[var(--lk-surface)] transition-transform hover:-translate-y-1"
            >
              <ImageBox
      ...
      {/* PRESS */}
      <div className="border-y-2 border-ink bg-[var(--lk-cream)] py-6">
        <Marquee fast>
          {press.map((mention) => (
      ...
      <section className="relative overflow-hidden border-t-2 border-ink bg-ink py-24 text-white">
        <div className="mx-auto grid max-w-7xl items-center gap-10 px-4 sm:px-6 lg:grid-cols-2">
          <Reveal>
            ...
            <div className="mt-8">
              <Link href="/shop/loup" className="btn-sticker border-2 border-white bg-[var(--lk-surface)] px-8 py-4 text-xl text-ink">
                Get LOUP — $149
              </Link>
            </div>
          </Reveal>
